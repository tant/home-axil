    ...
    <div className="container py-12 xl:py-24 h-[auto] text-center lg:py-0 lg:text-left lg:flex lg:justify-between">
      ...
      <div className="lg:w-1/2 xl:py-14 lg:py-8">
        ...
        >
          ...
          bold color schemes, we&apos;ll incorporate textures, patterns, and materials that make a statement. The result is a home that&apos;s not only beautiful but also functional and reflective of who you are.
        </motion.p>
        <motion.div
          initial="offscreen"
          whileInView={"onscreen"}
